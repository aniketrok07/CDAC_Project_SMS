...
export default function AddTeacher() {
    ...
    const Register = () => {
        ...
        axios.post(url + "/api/v1/teacher/addTeacher", body).then(res => {
                ...
                <form onSubmit={sendEmail}>
                    <table>
                        ...
                        <tr>
                            <td>Designation: </td>
                            <td>
                                <input onChange={e => { setDesignation(e.target.value) }} type="text" required />
                            </td>
                        </tr>
                        <tr>
                            <td>Monthly Salary: </td>
                            <td>
                                <input onChange={e => { setMonthSalary(e.target.value) }} type="text" required />
                            </td>
                        </tr>
                    </table>
